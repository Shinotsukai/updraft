...
class EditMaintenanceLog extends Component {
    ...
    componentDidMount() {
        ...
        axios.post('/api/Logging/MaintenanceLog/'+this.props.match.params.id, user)
        .then(response =>
            this.setState({
    ...
    onSubmit(e) {
        ...
        axios.post('/api/Logging/MaintenanceLog/update/'+this.props.match.params.id, logmaintenance)
   ...
   <div className="card text-center">
        <h5 className="card-header mb-2">Edit Maintenance Log</h5>
